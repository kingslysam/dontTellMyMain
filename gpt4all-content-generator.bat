...
ECHO 	This kit installation involves downloading ML model of size 4GB.
ECHO 	Hence, based on your network speed, the installation may take a while
ECHO======================================================================================
...
IF EXIST !WORKING_DIR!\%EXTRACTED_REPO_DIR%\ (
	...
	for /f %%A in ('copy /Z "%~dpf0" nul') do set "CR=%%A"
	<nul set/p"=->!CR!"
	ECHO 6. Repo extracted
)
EXIT /B 0	

:Download_model_checkpoint
CALL :LOG "Downloading Model checkpoint... "
